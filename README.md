...
- **Format autodetection** — Android logcat threadtime, syslog (RFC 3164), Apache CLF, ISO-8601, bare `MM-DD`, dlt-viewer text exports (AUTOSAR DLT), and plain text with timestamps normalized to a year-less `MM-DD HH:MM:SS.mmm` form.
