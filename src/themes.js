...
(function (root, factory) { if (typeof module === 'object' && module.exports) { module.exports = factory(); } else { Object.assign((root.LT || (root.LT = {})), factory()); } }(typeof self !== 'undefined' ? self : this, function () {
  ...
  const REQUIRED_VARS = [
    ...
    '--accent', '--accent-fg', '--hl', '--selection', '--hit',
  ...
  const THEMES = {
    midnight: {
      ...
      vars: {
        ...
        '--hl': '#ffd54a', '--selection': '#134e2f', '--hit': 'rgba(255,213,74,0.10)',
    ...
    paper: {
      ...
      vars: {
        ...
        '--hl': '#ffe28a', '--selection': '#b7e4c7', '--hit': 'rgba(191,135,0,0.13)',
        '--lvl-v': '#8a93a6', '--lvl-d': '#1c6fd1', '--lvl-i': '#1e7f4f',
        '--lvl-w': '#8a5600', '--lvl-e': '#c22f2f', '--lvl-f': '#b3126b',
        '--tint-w': 'rgba(168,106,0,0.08)', '--tint-e': 'rgba(194,47,47,0.10)',
        '--tint-f': 'rgba(179,18,107,0.12)',
        '--ok': '#1e7f4f', '--warn': '#8a5600', '--err': '#c22f2f',
      },
    },
    'solarized-dark': {
      ...
      vars: {
        ...
        '--hl': '#b58900', '--selection': '#21596b', '--hit': 'rgba(181,137,0,0.15)',
    ...
    'solarized-light': {
      ...
      vars: {
        ...
        '--hl': '#f2d675', '--selection': '#d5e8b8', '--hit': 'rgba(160,120,10,0.13)',
        '--lvl-v': '#93a1a1', '--lvl-d': '#268bd2', '--lvl-i': '#859900',
        '--lvl-w': '#8a6800', '--lvl-e': '#cb4b16', '--lvl-f': '#d33682',
        '--tint-w': 'rgba(181,137,0,0.12)', '--tint-e': 'rgba(203,75,22,0.12)',
        '--tint-f': 'rgba(211,54,130,0.12)',
        '--ok': '#859900', '--warn': '#8a6800', '--err': '#cb4b16',
      },
    },
    monokai: {
      label: 'Monokai (dark)',
      ...
      vars: {
        ...
        '--hl': '#fd971f', '--selection': '#3e5a41', '--hit': 'rgba(253,151,31,0.12)',
    ...
    'high-contrast': {
      ...
      vars: {
        ...
        '--hl': '#00ffff', '--selection': '#004400', '--hit': 'rgba(0,255,255,0.18)',
