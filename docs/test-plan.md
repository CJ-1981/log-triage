...
31.5 Start/end-of-log bands: on a 3-page load the first page shows only the "start of …" band, middle pages show none, and the last page shows only the "end of … — N lines" band; the bands sit inside the scroll area and row layout/scrolling/jumps stay exact around them.
